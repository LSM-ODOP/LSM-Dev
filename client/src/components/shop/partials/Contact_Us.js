...
function ContactForm() {
    ...
    const handleSubmit = (event) => {
        ...
        setSubmitted(true);
        // Here you might want to send formData to a server
    ...
    if (submitted) {
        return (
            <div className="thank-you-message">
                <p>Thank you for your interest in joining our platform! Your submission has been received, and our team will review your information.</p>
                <p>We are excited to have you as a part of this initiative to promote locally made products. We will be in touch with you shortly to discuss the next steps.</p>
            </div>
        );
    }
